  ...
  WebProjects: Project[] = [
    {
      ...
      category: 'Web-Apps',
      name: 'CompassAI',
      desc: 'CompassAI is an intelligent geospatial chatbot web app built with React, Node.js, and MongoDB. Integrated with interactive mapping tools, it enables users to perform spatial queries, apply dynamic symbology, generate analytical reports, and visualize data through charts — all via a conversational interface that makes geospatial data analysis smarter and more intuitive.',
      mainImg: './assets/detail_Projects/web/CompassAI/main/main.jpeg',
      subImgs: [
        './assets/detail_Projects/web/CompassAI/sub/1.jpeg',
        './assets/detail_Projects/web/CompassAI/sub/2.jpeg',
        './assets/detail_Projects/web/CompassAI/sub/3.jpeg',
        './assets/detail_Projects/web/CompassAI/sub/4.jpeg',
        './assets/detail_Projects/web/CompassAI/sub/5.jpeg',
        './assets/detail_Projects/web/CompassAI/sub/6.jpeg',
        './assets/detail_Projects/web/CompassAI/sub/7.jpeg',
        './assets/detail_Projects/web/CompassAI/sub/8.jpeg',
        './assets/detail_Projects/web/CompassAI/sub/9.jpeg',
        './assets/detail_Projects/web/CompassAI/sub/10.jpeg',
        './assets/detail_Projects/web/CompassAI/sub/11.jpeg',
        './assets/detail_Projects/web/CompassAI/sub/12.png',
        './assets/detail_Projects/web/CompassAI/sub/13.png',
      ],
      tech: [
        'Reactjs',
        'ReactQuery',
    ...
    },
    {
      ...
      category: 'Web-Apps',
      name: 'Male Fashion',
      desc: 'Male Fashion is a premium e-commerce platform dedicated to modern menswear, offering a high-performance shopping experience with real-time data synchronization and a seamless user interface.',
      mainImg: './assets/detail_Projects/web/male-fashion/main/main.png',
      subImgs: [
        './assets/detail_Projects/web/male-fashion/sub/1.png',
        './assets/detail_Projects/web/male-fashion/sub/2.png',
        './assets/detail_Projects/web/male-fashion/sub/3.png',
        './assets/detail_Projects/web/male-fashion/sub/4.png',
        './assets/detail_Projects/web/male-fashion/sub/5.png',
        './assets/detail_Projects/web/male-fashion/sub/6.png',
        './assets/detail_Projects/web/male-fashion/sub/7.png',
        './assets/detail_Projects/web/male-fashion/sub/8.png',
        './assets/detail_Projects/web/male-fashion/sub/9.png',
        './assets/detail_Projects/web/male-fashion/sub/10.png',
        './assets/detail_Projects/web/male-fashion/sub/11.png',
      ],
      tech: ['Reactjs', 'ReactQuery', 'Tailwind CSS', 'Supabase'],
      fronendGit: 'https://github.com/rafat962/Male-Fashion.git',
    },
    {
      id: 14,
      category: 'Web-Apps',
      name: 'SpotIN',
      desc: 'SpotIn is an intelligent workspace management and automation platform built with React, .NET Core, and SQL Server. It enables venue owners to track active bookings in real time, view live floor previews, and manage dynamic billing and cafeteria orders—all unified in a seamless B2B dashboard.',
      mainImg: './assets/detail_Projects/web/SpotIN/main/main.webp',
      subImgs: [
        './assets/detail_Projects/web/SpotIN/sub/1.webp',
        './assets/detail_Projects/web/SpotIN/sub/2.webp',
        './assets/detail_Projects/web/SpotIN/sub/3.webp',
        './assets/detail_Projects/web/SpotIN/sub/4.webp',
        './assets/detail_Projects/web/SpotIN/sub/5.webp',
        './assets/detail_Projects/web/SpotIN/sub/6.webp',
        './assets/detail_Projects/web/SpotIN/sub/7.webp',
        './assets/detail_Projects/web/SpotIN/sub/8.webp',
        './assets/detail_Projects/web/SpotIN/sub/9.webp',
        './assets/detail_Projects/web/SpotIN/sub/10.webp',
        './assets/detail_Projects/web/SpotIN/sub/11.webp',
        './assets/detail_Projects/web/SpotIN/sub/12.webp',
      ],
      tech: ['ASP.NET', 'sql-server', 'EF Core'],
      // video: 'https://www.facebook.com/100001750802724/videos/445272268384902/',
      fronendGit: 'https://github.com/rafat962/SpotIN.git',
    ...
    },
    {
      ...
      mainImg: './assets/detail_Projects/web/Hydro/main/main.jpeg',
      subImgs: [
        './assets/detail_Projects/web/Hydro/sub/1.jpeg',
        './assets/detail_Projects/web/Hydro/sub/2.jpeg',
        './assets/detail_Projects/web/Hydro/sub/3.jpeg',
        './assets/detail_Projects/web/Hydro/sub/4.jpeg',
        './assets/detail_Projects/web/Hydro/sub/5.jpeg',
        './assets/detail_Projects/web/Hydro/sub/6.jpeg',
        './assets/detail_Projects/web/Hydro/sub/7.jpeg',
      ],
      tech: [
        'Reactjs',
        'ReactQuery',
    ...
    },
    {
      ...
      name: 'Geo-Platform',
      desc: 'A web app for managing and visualizing geospatial data, built with React, Framer Motion, Node.js, Express, and MongoDB. It features a smooth, animated interface for an immersive user experience.',
      mainImg: './assets/detail_Projects/web/Geo-Platform/main/main2.webp',
      subImgs: [
    ...
    },
    {
      ...
      category: 'Web-Apps',
      name: 'Ecostead',
      desc: 'Ecostead is a full-stack real estate management platform built with React, Node.js, Express, and MongoDB. The frontend app provides an interactive map interface for exploring land plots and viewing detailed property information, while the backend app empowers administrators to update data, upload images, and efficiently manage land listings.',
      mainImg: './assets/detail_Projects/web/ecostead/main/main.jpeg',
      subImgs: [
        './assets/detail_Projects/web/ecostead/sub/1.jpeg',
        './assets/detail_Projects/web/ecostead/sub/2.jpeg',
        './assets/detail_Projects/web/ecostead/sub/3.jpeg',
        './assets/detail_Projects/web/ecostead/sub/4.jpeg',
        './assets/detail_Projects/web/ecostead/sub/5.jpeg',
      ],
      tech: [
        'Reactjs',
        'ReactQuery',
