  ...
  PythonProjects: Project[] = [
    {
      ...
      mainImg: './assets/detail_Projects/PYTHON/BarChart_project/main/main.png',
      subImgs: [
        './assets/detail_Projects/PYTHON/BarChart_project/sub/1.png',
        './assets/detail_Projects/PYTHON/BarChart_project/sub/2.png',
        './assets/detail_Projects/PYTHON/BarChart_project/sub/3.png',
      ],
    ...
    },
    {
      ...
      mainImg: './assets/detail_Projects/web/Web_ai_car_Detector/main/main.png',
      subImgs: [
        './assets/detail_Projects/web/Market_api/sub/2.png',
        './assets/detail_Projects/web/Market_api/sub/3.png',
        './assets/detail_Projects/web/Market_api/sub/4.png',
        './assets/detail_Projects/web/Market_api/sub/5.png',
        './assets/detail_Projects/web/Market_api/sub/6.png',
      ],
    ...
    },
    {
      ...
      mainImg: './assets/detail_Projects/web/RENTIZE/main/main.png',
      subImgs: [
        './assets/detail_Projects/web/RENTIZE/sub/1.png',
        './assets/detail_Projects/web/RENTIZE/sub/2.png',
        './assets/detail_Projects/web/RENTIZE/sub/3.png',
        './assets/detail_Projects/web/RENTIZE/sub/4.png',
        './assets/detail_Projects/web/RENTIZE/sub/5.png',
        './assets/detail_Projects/web/RENTIZE/sub/6.png',
      ],
      tech: [
        'ArcGIS Pro',
        'ArcGIS Online',
